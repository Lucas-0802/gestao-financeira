...
-- CreateEnum
CREATE TYPE "TransactionCategoty" AS ENUM ('HOUSING', 'TRANSPORTATION', 'FOOD', 'ENTERTAINMENT', 'HEALTH', 'UTILITY', 'SALARY', 'EDUCATION', 'OTHER');
...
CREATE TABLE "Transaction" (
    ...
    "category" "TransactionCategoty" NOT NULL,
